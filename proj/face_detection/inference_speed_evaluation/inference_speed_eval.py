# coding: utf-8
import sys
sys.path.append('/home/gate/lffd-dir/incubator-mxnet/python') # append mxnet python path if need
sys.path.append('../..')
import mxnet
...
#input_shape = (1,3,240,320) # (1, 3, 480, 640)(1,3,480,640) (1,3,720,1280) (1,3,1080,1920) (1,3,2160,3840)
